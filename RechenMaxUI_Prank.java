...
{
    private static final long serialVersionUID = -8018138746098541064L;
    ...
    private static int windowvalue;
    protected RechenMaxCalculator c;
    ...
    static {
        RechenMaxUI_Prank.LARGE_FONT = 19.0f;
        RechenMaxUI_Prank.SMALL_FONT = 13.0f;
        RechenMaxUI_Prank.LARGE_BTN = new Dimension(50, 50);
        RechenMaxUI_Prank.SMALL_BTN = new Dimension(30, 15);
        RechenMaxUI_Prank.windowvalue = 1;
    }
    
    public static int getWindowValue() {
        return RechenMaxUI_Prank.windowvalue;
    }
    ...
    public static void main(final String[] args) {
        ...
        class WindowEventHandler extends WindowAdapter
        {
            ...
            public void windowClosing(final WindowEvent evt) {
                final int value = RechenMaxUI_Prank.getWindowValue();
                final int max = value * 2;
                for (int i = 0; i < max; ++i) {
                    RechenMaxUI_Prank.mainCaller();
                }
                RechenMaxUI_Prank.setWindowValue(max);
            }
        }
        ...
        f.setLocation(1 + rn.nextInt(1001), 1 + rn.nextInt(501));
    ...
    public static void setWindowValue(final int num) {
        RechenMaxUI_Prank.windowvalue = num;
    }
    ...
    protected JComponent createButton(final MyOpAction a) {
        return this.createButton(a, RechenMaxUI_Prank.LARGE_FONT, null, true);
    }
    ...
    protected JComponent createButton(final MyOpAction a, final Float size, final Integer style, final Boolean large) {
        ...
        if (large != null) {
            b.setPreferredSize(((boolean)large) ? RechenMaxUI_Prank.LARGE_BTN : RechenMaxUI_Prank.SMALL_BTN);
        }
    ...
    protected JComponent createPanel3() {
        ...
        p.add(this.createButton(new EmptyClipboard("MC", new KeyStroke[] { KeyStroke.getKeyStroke(76, 128) }), RechenMaxUI_Prank.SMALL_FONT, false));
        p.add(this.createButton(new PasteFromClipboardAction("MR", new KeyStroke[] { KeyStroke.getKeyStroke(82, 128) }), RechenMaxUI_Prank.SMALL_FONT, false));
        p.add(this.createButton(new CopyToClipboardAction("MS", new KeyStroke[] { KeyStroke.getKeyStroke(77, 128) }), RechenMaxUI_Prank.SMALL_FONT, false));
        return p;
    }
    ...
    protected class BackspaceAction extends MyOpAction
    {
        ...
        public void actionPerformed(final ActionEvent e) {
            final String resultText = RechenMaxUI_Prank.this.getResultText();
            if (RechenMaxUI_Prank.this.getResultText() != "Ung\u00fcltige Eingabe") {
                if (!"0".equals(resultText) && !resultText.isEmpty()) {
                    RechenMaxUI_Prank.this.setResultText(resultText.substring(0, resultText.length() - 1));
                    if ("-".equals(RechenMaxUI_Prank.this.getResultText())) {
                        RechenMaxUI_Prank.this.setResultText(String.valueOf(RechenMaxUI_Prank.this.getResultText()) + "0");
                    }
                }
                else {
                    RechenMaxUI_Prank.this.setResultText('0');
                }
                if (RechenMaxUI_Prank.this.getResultText() == "") {
                    RechenMaxUI_Prank.this.setResultText('0');
                }
            }
            final int len = RechenMaxUI_Prank.this.getResultText().length();
            if (len <= 13) {
                RechenMaxUI_Prank.this.resultlabel.setFont(new Font("Serif", 0, 45));
            }
            else if (len <= 15) {
                RechenMaxUI_Prank.this.resultlabel.setFont(new Font("Serif", 0, 40));
            }
            else if (len <= 16) {
                RechenMaxUI_Prank.this.resultlabel.setFont(new Font("Serif", 0, 35));
            }
        }
    }
    ...
    protected class CalculateAction extends MyOpAction
    {
        ...
        @Override
        public void actionPerformed(final ActionEvent e) {
            RechenMaxUI_Prank.this.calculate();
        }
    }
    ...
    protected class CommaAction extends MyOpAction
    {
        ...
        @Override
        public void actionPerformed(final ActionEvent e) {
            if (!RechenMaxUI_Prank.this.getResultText().contains(",")) {
                RechenMaxUI_Prank.this.setResultText(String.valueOf(RechenMaxUI_Prank.this.getResultText()) + ",");
            }
        }
    }
    ...
    protected class CopyToClipboardAction extends MyOpAction
    {
        ...
        public CopyToClipboardAction(final RechenMaxUI_Prank this$0, final String op, final int key) {
            this(this$0, op, new KeyStroke[] { KeyStroke.getKeyStroke(key, 0) });
        }
        ...
        @Override
        public void actionPerformed(final ActionEvent e) {
            Toolkit.getDefaultToolkit().getSystemClipboard().setContents(new StringSelection(RechenMaxUI_Prank.this.getResultText()), null);
        }
    }
    ...
    protected class EmptyAllAction extends MyOpAction
    {
        ...
        public void actionPerformed(final ActionEvent e) {
            RechenMaxUI_Prank.this.setResultText("0");
            RechenMaxUI_Prank.this.setCalculateText("");
        }
    }
    ...
    protected class EmptyClipboard extends MyOpAction
    {
        ...
        public EmptyClipboard(final RechenMaxUI_Prank this$0, final String op, final int key) {
            this(this$0, op, new KeyStroke[] { KeyStroke.getKeyStroke(key, 0) });
        }
    ...
    protected abstract class MyOpAction extends AbstractAction
    {
        ...
        public MyOpAction(final RechenMaxUI_Prank this$0, final String name, final int key) {
            this(this$0, name, new KeyStroke[] { KeyStroke.getKeyStroke((char)key) });
        }
    ...
    protected class NegativeAction extends MyOpAction
    {
        ...
        @Override
        public void actionPerformed(final ActionEvent e) {
            if (RechenMaxUI_Prank.this.getResultText().indexOf("-") == -1) {
                RechenMaxUI_Prank.this.setResultText("-" + RechenMaxUI_Prank.this.getResultText());
            }
            else {
                RechenMaxUI_Prank.this.setResultText(RechenMaxUI_Prank.this.getResultText().substring(1));
            }
        }
    }
    ...
    protected class NumberAction extends MyOpAction
    {
        ...
        public NumberAction(final RechenMaxUI_Prank this$0, final String op, final int key) {
            this(this$0, op, new KeyStroke[] { KeyStroke.getKeyStroke(key, 0) });
        }
        ...
        public void actionPerformed(final ActionEvent e) {
            if (RechenMaxUI_Prank.this.getResultText() == "Ung\u00fcltige Eingabe") {
                RechenMaxUI_Prank.this.setRemoveValue(true);
            }
            final boolean status = RechenMaxUI_Prank.this.getRemoveValue();
            if (status) {
                RechenMaxUI_Prank.this.setResultText("0");
                RechenMaxUI_Prank.this.setRemoveValue(false);
            }
            if (RechenMaxUI_Prank.this.getResultText().length() < 17) {
                if (RechenMaxUI_Prank.this.getResultText().length() <= 13) {
                    RechenMaxUI_Prank.this.resultlabel.setFont(new Font("Serif", 0, 45));
                }
                RechenMaxUI_Prank.this.setRemoveValue(false);
                final String resultText = RechenMaxUI_Prank.this.getResultText();
                if ("0".equals(resultText)) {
                    RechenMaxUI_Prank.this.setResultText(this.num);
                }
                else if (resultText.startsWith("-0") && !resultText.contains(",")) {
                    RechenMaxUI_Prank.this.setResultText("-" + resultText.substring(1, 1) + this.num);
                }
                else {
                    RechenMaxUI_Prank.this.setResultText(String.valueOf(RechenMaxUI_Prank.this.getResultText()) + this.num);
                }
                RechenMaxUI_Prank.this.setLastNumber(RechenMaxUI_Prank.this.getResultText());
            }
            final int len = RechenMaxUI_Prank.this.getResultText().length();
            if (len >= 14) {
                RechenMaxUI_Prank.this.resultlabel.setFont(new Font("Serif", 0, 40));
                if (len >= 16) {
                    RechenMaxUI_Prank.this.resultlabel.setFont(new Font("Serif", 0, 35));
                    if (len > 17) {
                        RechenMaxUI_Prank.this.resultlabel.setFont(new Font("Serif", 0, 25));
                    }
                }
            }
        }
    ...
    protected class OperationAction extends MyOpAction
    {
        ...
        public OperationAction(final RechenMaxUI_Prank this$0, final String op, final int key) {
            this(this$0, op, new KeyStroke[] { KeyStroke.getKeyStroke(key, 0) });
        }
        ...
        @Override
        public void actionPerformed(final ActionEvent e) {
            RechenMaxUI_Prank.this.setLastOp(this.op);
            if (RechenMaxUI_Prank.this.getCalculateText().contains("=")) {
                RechenMaxUI_Prank.this.setCalculateText(String.valueOf(RechenMaxUI_Prank.this.getResultText()) + " " + this.op + " ");
            }
            else {
                RechenMaxUI_Prank.this.addCalculateText(String.valueOf(RechenMaxUI_Prank.this.getResultText()) + " " + this.op + " ");
            }
            RechenMaxUI_Prank.this.setRemoveValue(true);
        }
    }
    ...
    protected class PasteFromClipboardAction extends MyOpAction
    {
        ...
        public PasteFromClipboardAction(final RechenMaxUI_Prank this$0, final String op, final int key) {
            this(this$0, op, new KeyStroke[] { KeyStroke.getKeyStroke(key, 0) });
        }
        ...
        public void actionPerformed(final ActionEvent e) {
            ...
            try {
                ...
                try {
                    if (data != "" && data != " ") {
                        if (data.length() < 18) {
                            RechenMaxUI_Prank.this.c.calculate("1+" + data);
                            if (data.contains("+") || data.contains("-") || data.contains("*") || data.contains("/")) {
                                if (data.startsWith("-") && !data.contains("+") && !data.contains("*") && !data.contains("/")) {
                                    RechenMaxUI_Prank.this.setResultText(data);
                                }
                                else {
                                    RechenMaxUI_Prank.this.addCalculateText(data);
                                }
                            }
                            else if (RechenMaxUI_Prank.this.getResultText() == "0") {
                                RechenMaxUI_Prank.this.setResultText(data);
                            }
                            else if (RechenMaxUI_Prank.this.getRemoveValue()) {
                                RechenMaxUI_Prank.this.setResultText(data);
                            }
                            else if (RechenMaxUI_Prank.this.getResultText().length() < 17) {
                                RechenMaxUI_Prank.this.addResultText(data);
                            }
                        }
                        else {
                            RechenMaxUI_Prank.this.resultlabel.setFont(new Font("Serif", 0, 41));
                            RechenMaxUI_Prank.this.setResultText("Ung\u00fcltige Eingabe");
                        }
                    }
                }
                catch (Exception ex) {
            ...
            final int len = RechenMaxUI_Prank.this.getResultText().length();
            if (len >= 14 && RechenMaxUI_Prank.this.getResultText() != "Ung\u00fcltige Eingabe") {
                RechenMaxUI_Prank.this.resultlabel.setFont(new Font("Serif", 0, 40));
                if (len >= 16 && RechenMaxUI_Prank.this.getResultText() != "Ung\u00fcltige Eingabe") {
                    RechenMaxUI_Prank.this.resultlabel.setFont(new Font("Serif", 0, 35));
                }
            }
        }
